...
const reducer = (accumulator, currentValue) => accumulator + currentValue; // opération permettant de prendre la valeur totale 
  ...
  function addLi(inner, restaurantName, url, valeur, adresse) {
...
function toggle(){ // fonction pour dérouler le callapsible et voir le content des notes et commentaires ajoutés
...
for (var i = 0; i < note.length; i++) {
  var price = note[i].innerText;
  console.log("Price: " + price);
  noteTableau.push(price);
  }	
  
// console.log(noteTableau);
	// if (valeurRate2 >= noteTableau) {
